...
<title>구글 시트 연동 — 스타크래프트 끝장전 기록실</title>
<meta name="description" content="끝장전 기록실 데이터를 구글 시트에서 IMPORTDATA 로 바로 불러오는 방법.">
<link rel="canonical" href="https://starendgame.com/sheets.php">
<meta property="og:type" content="website">
<meta property="og:site_name" content="스타크래프트 끝장전 기록실">
<meta property="og:title" content="구글 시트 연동 — 스타크래프트 끝장전 기록실">
<meta property="og:description" content="끝장전 기록실 데이터를 구글 시트에서 IMPORTDATA 로 바로 불러오는 방법.">
<meta property="og:url" content="https://starendgame.com/sheets.php">
...
<header><div class="headrow"><img class="brandlogo" src="https://stimg.sooplive.com/LOGO/ta/talent/m/talent.webp" alt=""><div><h1><a href="index.php">스타크래프트 끝장전 기록실</a></h1><div class="sub">구글 시트 연동</div></div></div></header>
<a class="backlink" href="index.php">← 기록실 홈으로</a>
<div class="card"><div class="cardtitle">한 줄 요약</div><div class="hint">구글 시트 아무 칸에 아래 수식을 붙여넣으면 끝입니다. 파일을 내려받아 올릴 필요가 없고, 이 사이트가 갱신되면 시트도 따라 갱신됩니다.</div><pre>=IMPORTDATA("https://starendgame.com/csv/players.csv")</pre><div class="hint">한글이 깨져 보이면 두 번째 인자로 구분자를 지정해 보세요 — <code class="inline">=IMPORTDATA("…", ",")</code></div></div>
<div class="card"><div class="cardtitle">파일 목록</div><div class="tblwrap"><table><thead><tr><th class="static">파일</th><th class="static">내용</th><th class="static">구글 시트 수식</th><th class="static">직접 받기</th></tr></thead><tbody><tr><td class="nm">선수</td><td class="muted">선수별 통산 전적과 종족별 세트 전적</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/players.csv")</code></td><td><a class="dlbtn" href="csv/players.csv" download>내려받기</a></td></tr><tr><td class="nm">경기</td><td class="muted">매치 한 줄씩 — 날짜·대진·스코어·맵·다시보기</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/matches.csv")</code></td><td><a class="dlbtn" href="csv/matches.csv" download>내려받기</a></td></tr><tr><td class="nm">세트별 맵</td><td class="muted">매치 안의 세트마다 어떤 맵을 썼는지</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/sets.csv")</code></td><td><a class="dlbtn" href="csv/sets.csv" download>내려받기</a></td></tr><tr><td class="nm">맵</td><td class="muted">맵별 사용 세트 수와 종족 상성</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/maps.csv")</code></td><td><a class="dlbtn" href="csv/maps.csv" download>내려받기</a></td></tr><tr><td class="nm">상대전적</td><td class="muted">선수 대 선수 맞대결 기록</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/headtohead.csv")</code></td><td><a class="dlbtn" href="csv/headtohead.csv" download>내려받기</a></td></tr><tr><td class="nm">연도별</td><td class="muted">연도별 매치·세트 수와 종족 상성</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/yearly.csv")</code></td><td><a class="dlbtn" href="csv/yearly.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 선수</td><td class="muted">ASL 선수별 통산 성적과 우승 횟수</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-players.csv")</code></td><td><a class="dlbtn" href="csv/asl-players.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 대회</td><td class="muted">대회별 규모와 우승·준우승</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-tournaments.csv")</code></td><td><a class="dlbtn" href="csv/asl-tournaments.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 매치</td><td class="muted">매치(시리즈) 한 줄씩 — 대회·라운드·대진·스코어</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-matches.csv")</code></td><td><a class="dlbtn" href="csv/asl-matches.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 세트</td><td class="muted">세트 한 줄씩 — 어떤 맵에서 누가 이겼는지</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-sets.csv")</code></td><td><a class="dlbtn" href="csv/asl-sets.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 맵</td><td class="muted">맵별 사용 세트 수와 종족 상성</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-maps.csv")</code></td><td><a class="dlbtn" href="csv/asl-maps.csv" download>내려받기</a></td></tr><tr><td class="nm">ASL 상대전적</td><td class="muted">선수 대 선수 맞대결 기록</td><td><code class="inline">=IMPORTDATA("https://starendgame.com/csv/asl-headtohead.csv")</code></td><td><a class="dlbtn" href="csv/asl-headtohead.csv" download>내려받기</a></td></tr></tbody></table></div></div>
<div class="card"><div class="cardtitle">엑셀로 한 번에 받기</div><div class="hint">여섯 개 시트가 한 파일에 들어 있습니다. 구글 시트에서 <b>파일 → 가져오기 → 업로드</b> 로 올리면 그대로 열립니다.</div><div style="margin-top:10px"><a class="dlbtn on" href="xlsx/sc-endgame.xlsx" download>sc-endgame.xlsx 내려받기</a></div></div>
<div class="card"><div class="cardtitle">원본 JSON</div><div class="hint">사이트가 쓰는 원본 데이터 전체입니다. 프로그램으로 가공할 때 쓰세요.</div><pre>https://starendgame.com/data/endgame.json</pre></div>
<div class="card"><div class="cardtitle">자동 갱신되게 하려면</div><ol class="steps"><li>시트에 <code class="inline">IMPORTDATA</code> 수식을 넣습니다.</li><li><b>파일 → 설정 → 계산</b> 에서 재계산을 <b>변경할 때 및 매시간</b> 으로 둡니다.</li><li>이 사이트가 갱신되면 최대 한 시간 안에 시트에도 반영됩니다.</li></ol><div class="hint">수식이 아니라 값으로 굳히고 싶으면 범위를 복사한 뒤 <b>선택하여 붙여넣기 → 값만</b> 을 쓰세요.</div></div>
<footer>
