...
<title>박재현 (프로토스) — ASL 기록실</title>
<meta name="description" content="박재현 프로토스 · ASL 우승 0회 · 매치 0승 2패(0.0%) · 세트 0승 2패(0.0%) · 1개 대회 출전">
<link rel="canonical" href="https://starendgame.com/asl/p/park-jaehyeon.php">
<meta property="og:type" content="website">
<meta property="og:site_name" content="스타크래프트 끝장전 기록실">
<meta property="og:title" content="박재현 (프로토스) — ASL 기록실">
<meta property="og:description" content="박재현 프로토스 · ASL 우승 0회 · 매치 0승 2패(0.0%) · 세트 0승 2패(0.0%) · 1개 대회 출전">
<meta property="og:url" content="https://starendgame.com/asl/p/park-jaehyeon.php">
...
<div class="card"><div class="cardtitle">상대 전적<span class="note">2명</span></div><div class="tblwrap"><table><thead><tr><th class="static">상대</th><th class="static num">매치</th><th class="static num">세트</th><th class="static num">세트 승률</th></tr></thead><tbody><tr><td><a href="park-seonggyun.php"><span class="race T">T</span><span class="nm-link">박성균</span></a></td><td class="num">0-1</td><td class="num">0-1</td><td class="num">0.0%</td></tr><tr><td><a href="cho-giseok.php"><span class="race T">T</span><span class="nm-link">조기석</span></a></td><td class="num">0-1</td><td class="num">0-1</td><td class="num">0.0%</td></tr></tbody></table></div></div>
<div class="card"><div class="cardtitle">전체 경기<span class="note">2매치 · 최신 대회순</span></div><div class="tblwrap"><table><thead><tr><th class="static hide-mobile">대회</th><th class="static">라운드</th><th class="static">상대</th><th class="static num">스코어</th><th class="static hide-mobile">맵</th></tr></thead><tbody><tr><td class="muted hide-mobile"><a href="../t/pre.php"><span class="nm-link">대국민 스타리그</span></a></td><td class="muted">32강</td><td><a href="cho-giseok.php"><span class="race T">T</span><span class="nm-link">조기석</span></a></td><td class="num lose">0-1</td><td class="muted hide-mobile" style="white-space:normal">서킷브레이커</td></tr><tr><td class="muted hide-mobile"><a href="../t/pre.php"><span class="nm-link">대국민 스타리그</span></a></td><td class="muted">32강</td><td><a href="park-seonggyun.php"><span class="race T">T</span><span class="nm-link">박성균</span></a></td><td class="num lose">0-1</td><td class="muted hide-mobile" style="white-space:normal">투혼</td></tr></tbody></table></div></div>
<div class="dlbox">
