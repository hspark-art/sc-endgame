...
<title>최영현 (프로토스) — ASL 기록실</title>
<meta name="description" content="최영현 프로토스 · ASL 우승 0회 · 매치 0승 2패(0.0%) · 세트 0승 2패(0.0%) · 1개 대회 출전">
<link rel="canonical" href="https://starendgame.com/asl/p/choi-yeonghyeon.php">
<meta property="og:type" content="website">
<meta property="og:site_name" content="스타크래프트 끝장전 기록실">
<meta property="og:title" content="최영현 (프로토스) — ASL 기록실">
<meta property="og:description" content="최영현 프로토스 · ASL 우승 0회 · 매치 0승 2패(0.0%) · 세트 0승 2패(0.0%) · 1개 대회 출전">
<meta property="og:url" content="https://starendgame.com/asl/p/choi-yeonghyeon.php">
...
<header style="border-bottom:none;padding-bottom:0"><div class="phead"><span class="race P">P</span><span class="pname">최영현</span><span class="ptag">프로토스</span></div><div class="stats-strip"><div class="item">매치 전적<b>0승 2패 · 0.0%</b></div><div class="item">세트 전적<b>0승 2패 · 0.0%</b></div><div class="item">출전 대회<b>1개</b></div><div class="item">최고 성적<b>24강</b></div></div></header>
<div class="card" style="margin-top:16px"><div class="cardtitle">종족별 세트 전적</div><div class="murow"><div class="mulabel"><span><span class="race P">P</span>프로토스 <b>0</b></span><span><b>2</b> 테란<span class="race T">T</span></span></div><div class="mubar"><span style="width:0.0000%;background:var(--p)"></span><span style="width:100.0000%;background:var(--t)">100.0%</span></div></div></div>
...
<div class="card"><div class="cardtitle">상대 전적<span class="note">2명</span></div><div class="tblwrap"><table><thead><tr><th class="static">상대</th><th class="static num">매치</th><th class="static num">세트</th><th class="static num">세트 승률</th></tr></thead><tbody><tr><td><a href="park-seonggyun.php"><span class="race T">T</span><span class="nm-link">박성균</span></a></td><td class="num">0-1</td><td class="num">0-1</td><td class="num">0.0%</td></tr><tr><td><a href="byun-hyeongtae.php"><span class="race T">T</span><span class="nm-link">변형태</span></a></td><td class="num">0-1</td><td class="num">0-1</td><td class="num">0.0%</td></tr></tbody></table></div></div>
<div class="card"><div class="cardtitle">전체 경기<span class="note">2매치 · 최신 대회순</span></div><div class="tblwrap"><table><thead><tr><th class="static hide-mobile">대회</th><th class="static">라운드</th><th class="static">상대</th><th class="static num">스코어</th><th class="static hide-mobile">맵</th></tr></thead><tbody><tr><td class="muted hide-mobile"><a href="../t/asl02.php"><span class="nm-link">ASL Season 2</span></a></td><td class="muted">24강</td><td><a href="byun-hyeongtae.php"><span class="race T">T</span><span class="nm-link">변형태</span></a></td><td class="num lose">0-1</td><td class="muted hide-mobile" style="white-space:normal">벤젠</td></tr><tr><td class="muted hide-mobile"><a href="../t/asl02.php"><span class="nm-link">ASL Season 2</span></a></td><td class="muted">24강</td><td><a href="park-seonggyun.php"><span class="race T">T</span><span class="nm-link">박성균</span></a></td><td class="num lose">0-1</td><td class="muted hide-mobile" style="white-space:normal">서킷브레이커</td></tr></tbody></table></div></div>
<div class="dlbox">
